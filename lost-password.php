<?php
    ...
    if(!empty($_POST['username']))
    {
        ...
        if ($result = mysqli_query($link, $sql)) {
            ...
            {
                if($_POST['id_number']==$row['id_number'] && $_POST['email']==$row['email'])
                {
                    $sql="UPDATE member SET password='000000' WHERE account='".$row['account']."'";
                    $update = mysqli_query($link, $sql) or die("error");
                    echo '<script language="JavaScript">;alert("已將您的密碼改為預設值: 000000 ，請盡快前去更新密碼");location.href="login.php";</script>;';
                }
                else
                {
                    echo '<script language="JavaScript">;alert("資料填寫錯誤，如有疑問請聯繫服務人員");location.href="lost-password.php";</script>;';
                }
                    ...
                    <div class="container clr page-header-inner">
                        ...
                        <nav aria-label="Breadcrumbs" class="site-breadcrumbs clr position-" itemprop="breadcrumb">
                            <ol class="trail-items" itemscope itemtype="http://schema.org/BreadcrumbList">
                                ...
                                <li class="trail-item trail-end" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem"><a href="lost-password.php" itemtype="https://schema.org/Thing" itemprop="item"><span itemprop="name">忘記密碼</span></a>
                                    ...
                                    <div class="woocommerce">
                                        ...
                                        <div class="oceanwp-loginform-wrap">
                                            <ul class="owp-account-links registration-disabled">
                                                <li class="login"><span class="owp-account-link current">忘記密碼</span></li>
                                            </ul>
                                            <h2>忘記密碼</h2>
                                            <p align="center"><span style="font-size: 16px;" >為驗證您的身分，請依據您註冊時所填的基本資料回答下列項目</span></p>
                                            <form class="woocommerce-form woocommerce-form-login login" name="form1" id="form1" antion="lost-password.php" method="POST">


                                                <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                                                    <label for="username">使用者名稱 &nbsp;<span class="required">*</span></label>
                                                    <input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="username" id="username" autocomplete="username" value="" placeholder="" /> 
                                                ...
                                                <p class="form-row">
                                                    <button type="submit" class="woocommerce-button button woocommerce-form-login__submit" name="check" value="確認">送出</button>
                                                </p>
                                                <p class="form-row">
