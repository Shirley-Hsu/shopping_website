<?php
    ...
    if(isset($_GET['text']))
        $sql="SELECT * FROM product where name like '%".$_GET['text']."%'";
    else
            ...
            <main id="main" class="site-main clr" role="main">
                ...
                <header class="page-header background-image-page-header">
                    ...
                    <div class="container clr page-header-inner">
                        ...
                        <h1 class="page-header-title clr" itemprop="headline"><?php echo "關鍵字--".$_GET['text']; ?></h1>
                        ...
                        <nav aria-label="Breadcrumbs" class="site-breadcrumbs clr position-" itemprop="breadcrumb">
                            <ol class="trail-items" itemscope itemtype="http://schema.org/BreadcrumbList">
                                ...
                                <li class="trail-item trail-end" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem"><a href="search.php?text=<?php echo $_GET['text'] ?>"><itemtype="https://schema.org/Thing" itemprop="item"><span itemprop="name"><?php echo "關鍵字--".$_GET['text']; ?></span></a><meta content="3" itemprop="position" />
                                ...
                                <div class="oceanwp-toolbar clr">
                                    ...
                                    <form class="woocommerce-ordering" method="get">
                                        <select name="orderby" class="orderby" aria-label="商店訂單">
												...
												<option value="price-desc" <?php if(isset($_GET["orderby"]) && $_GET["orderby"]=='price_desc') echo "selected='selected'";?>>依價格排序:高至低</option>
										</select>
                        ...
                        <div id="right-sidebar-inner" class="clr">
                            ...
                            <div id="woocommerce_product_categories-2" class="sidebar-box woocommerce widget_product_categories clr">
                                ...
                                <ul class="product-categories">
                                    <li class="cat-item cat-item-31 "><a href="shop.php?classify=<?php echo "全部商品"; ?>">全部</a></li>
                                    <li class="cat-item cat-item-35 "><a href="shop.php?classify=<?php echo "清潔用品"; ?>">清潔用品</a></li>
                                    <li class="cat-item cat-item-30 "><a href="shop.php?classify=<?php echo "生活用品"; ?>">生活用品</a></li>
                                    <li class="cat-item cat-item-29 "><a href="shop.php?classify=<?php echo "外出用具"; ?>">外出用具</a></li>
                                    <li class="cat-item cat-item-28 "><a href="shop.php?classify=<?php echo "食物"; ?>">食物</a></li>
                                    <li class="cat-item cat-item-33 "><a href="shop.php?classify=<?php echo "衣服"; ?>">衣服</a></li>
                                    <li class="cat-item cat-item-32 "><a href="shop.php?classify=<?php echo "玩具"; ?>">玩具</a></li>
                                </ul>
                            </div>
